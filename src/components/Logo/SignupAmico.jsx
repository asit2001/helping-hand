...
const SignupAmico = (props) => {
  return (
    <svg className="signupSvg" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="freepik--window--inject-2">
        <g id="freepik--tab--inject-2">
          ...
          <g id="freepik--Button--inject-2">
            <g id="freepik--shadow--inject-2" style={{ opacity: "0.2" }}>
      ...
      <g id="freepik--user-icon--inject-2">
